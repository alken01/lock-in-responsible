...
import { idlFactory } from './frontend_icp.did.js';
export { idlFactory } from './frontend_icp.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FRONTEND_ICP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./frontend_icp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the frontend_icp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./frontend_icp.did.js")._SERVICE>}
 */
export const frontend_icp = createActor(canisterId);
